"""
Django settings for DecoPath project.
...
SECRET_KEY = '$_jzv1fxs=$2*(ux9qx64zzdva)uemwocs@y3-twc+7k6h$e9i'
...
WSGI_APPLICATION = 'DecoPath.wsgi.application'
